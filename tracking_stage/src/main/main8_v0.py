...
VIDEO = r"C:\Users\Hikaru Shishido\Desktop\高速ライトシート顕微鏡利活用PJ\追跡システム\C.elegans\230831\20230831182253-1\rec.avi"

MAINPC_PATH = r"C:\Users\Hikaru Shishido\Documents\Python\StageControl\PC_PATH.txt"
START_TIME = r"C:\Users\Hikaru Shishido\Documents\Python\StageControl\START_TIME.txt"
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.ui = uic.loadUi("Gui\prototype.ui",self)
    ...
    def Ready(self):
        ...
        variable.log_file.write("frame,time,x(pixel),y(pixel),radius(pixel),asobi(pixel),Δt(s),Δd(μm),track_v(μm/s),err(μm),sum_x(pixel),sum_y(pixel),13,kal_x,kal_y\n")
    ...
    def run(self):
        ...
        while end_flag:
            ...
            if(variable.detect_flag == True):
                image_operation2.onMouse(self,variable.click_x,variable.click_y,variable.radius)
            ...
            if self.features is not None or (detection_x is not None and detection_y is not None):
                if  len(self.features) != 0:
                    ...
                    image_operation2.onMouse(self,detection_x,detection_y,variable.radius)
                    #print("No Detection")
                ...
                if detection_x is not None and detection_y is not None and previous_x is not None and previous_y is not None:
                    if(variable.track_flag == True):
                        ...
                        if self.delta_d_flag < 5:
                            self.m = 0.4
                        elif self.delta_d_flag >= variable.asobi and self.delta_d_flag < 10:
                            self.m = 0.6
                        elif self.delta_d_flag >= 5 and self.delta_d_flag < 15:
                            self.m = 0.8
                        else:
                            self.m = 1
