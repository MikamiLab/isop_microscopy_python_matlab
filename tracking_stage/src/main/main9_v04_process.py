...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        # 速度設定
        AxisSpeed = Pxep.SPDPARAM(1,600,600,30000,100,40,0,0,0,0,0,0)
    ...
    def run(self):
        ...
        while end_flag:
            ...
            if (variable.flag == True) :
                ...
                Que.put(self.frame,block=False)
            else:
                pass
...
if __name__ == "__main__":
    ...
    window.show()
    Que = Queue()
    process = Process(target=rec, args=(Que,))
    process.start()
    sys.exit(app.exec_())
