...
class UIFunctions(MainWindow):
    ...
    def uiDefinitions(self):
        ...
        self.ui.pushButton_PoseEstimationON.pressed.connect(lambda: UIFunctions.PoseEstimationON(self))
        self.ui.pushButton_PoseEstimationOFF.pressed.connect(lambda: UIFunctions.PoseEstimationOFF(self))
    ...
    def flag_update_to_thread(self):
        '''
        '''
        self.cthread.flag_update_from_main(self.track_flag, self.save_flag, self.detect_flag, self.reset_flag, self.simulation_flag, self.pose_flag, self.do_in_laptop)
    ...
    def TrackON(self):
        ...
        if self.click_x and self.click_y != None:
            ...
            self.ui.pushButton_PoseEstimationON.setEnabled(True)
    ...
    def TrackOFF(self):
        ...
        UIFunctions.PoseEstimationOFF(self)
    ...
    def PoseEstimationON(self):
        '''
        '''
        self.pose_flag = True
        UIFunctions.flag_update_to_thread(self)
        self.ui.pushButton_PoseEstimationON.setEnabled(False)
        self.ui.pushButton_PoseEstimationOFF.setEnabled(True)
        self.ui.pushButton_PoseEstimationON.setStyleSheet("background-color: red")
    
    def PoseEstimationOFF(self):
        '''
        '''
        self.pose_flag = False
        UIFunctions.flag_update_to_thread(self)
        self.ui.pushButton_PoseEstimationON.setEnabled(True)
        self.ui.pushButton_PoseEstimationOFF.setEnabled(False)
        self.ui.pushButton_PoseEstimationON.setStyleSheet("background-color: rgb(52, 59, 72)")
    ...
    def Arrow_keys(self):
        ...
        if self.ui.radioButton_Marker.isChecked():
            ...
            if sender == self.ui.pushButton_Up:
                _, _ = self.scl.wDriveStart(self.pulse, 3)
            elif sender == self.ui.pushButton_Down:
                _, _ = self.scl.wDriveStart(self.pulse, 2)
            elif sender == self.ui.pushButton_Left:
                _, _ = self.scl.wDriveStart(self.pulse, 1)
            elif sender == self.ui.pushButton_Right:
                _, _ = self.scl.wDriveStart(self.pulse, 0)
            elif sender == self.ui.pushButton_UpLeft:
                _, _ = self.scl.wDriveStart(self.pulse, 7)
            elif sender == self.ui.pushButton_UpRight:
                _, _ = self.scl.wDriveStart(self.pulse, 5)
            elif sender == self.ui.pushButton_LowLeft:
                _, _ = self.scl.wDriveStart(self.pulse, 6)
            elif sender == self.ui.pushButton_LowRight:
                _, _ = self.scl.wDriveStart(self.pulse, 4)
